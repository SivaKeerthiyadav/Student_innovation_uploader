...
<html>
<head>
	<title>Student innovation</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="container">
<a href="https://lexacademy.in" target="_blank"><img src="images/logov.png" alt="" width="350px" ></a><br><hr>
...
?>
  ...
  <i class="fa fa-plus"></i> Add New Idea
  </button>
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
				...
				<th class="text-center" scope="col">problem Statement</th>
				<th class="text-center" scope="col">idea</th>
			...
			//	$u_phone = $row['u_phone'];
				...
				<td class='text-left'>$u_l_name   </td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="images/vlogos.png" width="300px" height="80px" alt=""></center>
...
<input type="text" class="form-control" name="card_no" placeholder="Enter your name" maxlength="12" required>
</div>
<div class="form-group col-md-6">
...
<div class="form-row" style="color:#000000;">
<div class="form-group col-md-6">
...
<div class="form-group col-md-6">
<label for="inputPasswor">Your Institute name</label>
<input type="text" class="form-control" name="user_dob" placeholder="enter your school/college name">
</div>
</div>
...
<div class="form-row">
<div class="form-group col-md-6">
<label for="firstname">Problem Statement</label>
<input type="text" class="form-control" name="user_first_name" placeholder="Enter Problem Statement ">
</div>
<div class="form-group col-md-6">
<label for="lastname">Summarize Your Idea</label>
<input type="text" class="form-control" name="user_last_name" placeholder="Summarize Your Idea">
</div>
</div>
...
<div class="form-row">
<div class="form-group col-md-6">
<label for="fathername">List pertinent details of your idea</label>
<input type="text" class="form-control" name="user_father" placeholder="Enter pertinent details">
</div>
<div class="form-group col-md-6">
<label for="mothername">What makes your idea Unique</label>
<input type="text" class="form-control" name="user_mother" placeholder="Enter What makes your idea Unique">
</div>
</div>
...
<div class="form-group">
<label for="family">Additional Information</label>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<strong>idea :</strong> $father <br>
						<strong>problem statement :</strong>$mother <br>
						...
						<i class='fa fa-users' aria-hidden='true'></i> additional info :
								<div class='card-body'>
								<p> $family </p>
								</div>
						</div>
						
						<i class='fa fa-home' aria-hidden='true'> Institution </i> $village, $police, <br> $dist, $state - $pincode
						<br />
						</p>
						<!-- Split button -->
					</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='lastname'>Aadhar No.</label>
